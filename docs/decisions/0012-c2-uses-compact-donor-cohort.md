...
**Supersedes:** the donor specification in C2 v2; retained for C2 v4
...
C2 v3 first introduced all 14 sealed D2b-2 real compact donors unchanged; its
scorer-validation run was void under decision 0014. C2 v4 retains the same
donor archive and records
...
Downstream non-rigid and stitching evaluations consume only valid C2 v4 outputs.
D2b-1 remains blocked until C2 v4 and its compact-donor oracle evaluation are
