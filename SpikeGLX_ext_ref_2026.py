...
seg_motion = correct_motion(seg_pre_motion_est, rec_for_sorting=seg_pre_sorting, cache_dir=previous_dir / 'motion', recalc=False, method='dredge')
...
sorter_params['Th_universal'] = 9#4#9#14#
sorter_params['Th_learned'] = 8#3#8#12#
...
sorter_params['cross_peel_claim_um'] = 75
...
try:
    ...
    seg_saved = save_binary_recording(seg_motion, previous_dir / 'preprocessed_recording', recalc=False)
    del seg_motion
    try:
        import torch
