...
ROOT=Path(__file__).resolve().parents[1];SRC=ROOT/'testing/outputs';OUT=SRC/'luke_early_medicine_peak_comparison_v3';OLD=SRC/'luke_early_medicine_peak_comparison_v1'
...
for col,arm in enumerate(['original','compensated']):
 ...
 for name,src,c in [('MEDiCINe 1 s',SRC/'luke_early_medicine_peak_comparison_v2','#D55E00'),('MEDiCINe 5 s',OUT,'#009E73')]:
