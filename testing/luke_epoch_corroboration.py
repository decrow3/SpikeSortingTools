...
OUT=ROOT/'testing/outputs/luke_epoch_corroboration_v1'
...
def main():
    ...
    for cid in labels.loc[labels.KSLabel=='good','cluster_id']:
        ...
        a=events[events<10*fs];b=events[events>=10*fs]
    ...
    blocks=[dict(name='stable_validation',start=4090.,duration=10.,native_relative=0.)]
