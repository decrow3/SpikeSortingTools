...
OUT=SRC/'luke_early_medicine_peak_comparison_v6'
PRE=SRC/'luke_long_context_validation_v1'
FS=29999.835983263598
ARGS=dict(motion_bound=500.,time_bin_size=.25,num_depth_bins=4,time_kernel_width=1.,amplitude_threshold_quantile=0.,training_steps=10000,plot_figures=False)
def main():
    ...
    manifest['dredge_source']='v6 fresh DREDGE: 0.25 s bins, 1 s Gaussian histogram sigma, strict pairwise bound 250 um'
