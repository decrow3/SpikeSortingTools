...
ROOT=Path(__file__).resolve().parents[1];SRC=ROOT/'testing/outputs';OUT=SRC/'luke_early_medicine_peak_comparison_v7';OLD=SRC/'luke_early_medicine_peak_comparison_v1'
...
for col,arm in enumerate(['original','compensated']):
 ...
 methods=[('DREDGE · 0.25 s Gaussian',z['time_s'],z['depth_um'],z['displacement_um'],'#0072B2',3)]
