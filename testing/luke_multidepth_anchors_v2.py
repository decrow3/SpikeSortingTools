...
OUT=ROOT/'testing/outputs/luke_multidepth_anchors_v2'
...
def main():
    ...
    for row in prior.itertuples():
        ...
        negatives=np.where((control[notknown,1]>=.4)&(control[notknown,1]<=2.5),control[notknown,0],0.)
